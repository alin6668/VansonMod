...
- **Memory Debug**: 정확 검색, 퍼지 검색, 그룹 검색, 범위 검색, 주변 검색, 검색 타임라인을 통한 이전 결과 복원, 마지막 수동 쓰기 실행 취소, 결과 필터링, 일괄 수정, 값 보기 / Hex 보기 이동을 제공합니다.
...
- **메모리 검색 및 일괄 편집**: 정확, 퍼지, 그룹, 범위, 주변 검색, 검색 타임라인 스냅샷 복원, 수동 수정 실행 취소, 크다 / 작다 / 구간 필터, 고정값 쓰기, 증가형 수정, 일괄 잠금, 일괄 즐겨찾기를 지원합니다.
