...
- **記憶體調試**：提供精確、模糊、聯合、範圍、臨近搜尋，支援搜尋時間線恢復歷史結果、手動寫入撤回、結果篩選、批次修改，以及數值視圖 / Hex 視圖跳轉。
...
- **記憶體搜尋與批次修改**：支援精確、模糊、聯合、範圍、臨近搜尋，支援搜尋時間線快照與恢復、手動修改值撤回、大於 / 小於 / 區間篩選、固定值寫入、遞增修改、批量鎖定與批量收藏。
