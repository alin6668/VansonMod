...
- **Memory Debug**: ค้นหาแบบ exact, fuzzy, group, range และ nearby พร้อมไทม์ไลน์สำหรับกู้คืน snapshot ผลลัพธ์ ย้อนกลับการเขียนค่าด้วยมือครั้งล่าสุด กรองผล แก้ไขค่าหลายรายการ และกระโดดไปมุมมองค่า / Hex
...
- **ค้นหาหน่วยความจำและแก้ไขหลายรายการ**: รองรับ exact, fuzzy, group, range และ nearby search พร้อม snapshot ไทม์ไลน์และการกู้คืน การย้อนกลับการแก้ไขด้วยมือ ตัวกรองมากกว่า/น้อยกว่า/ช่วง การเขียนค่าแบบคงที่ การแก้ไขแบบเพิ่มค่า การล็อกหลายรายการ และเพิ่มรายการโปรดหลายรายการ
