...
- **Memory Debug**：精確検索、ファジー検索、グループ検索、範囲検索、近傍検索、検索タイムラインからの結果復元、手動書き込みの取り消し、結果フィルタ、バッチ編集、値ビュー / Hex ビューへのジャンプを行えます。
...
- **メモリ検索と一括編集**：精確、ファジー、グループ、範囲、近傍検索、検索タイムラインのスナップショット復元、手動変更の取り消し、大小比較、範囲フィルタ、固定値書き込み、増分編集、一括ロック、一括お気に入りを利用可能。
